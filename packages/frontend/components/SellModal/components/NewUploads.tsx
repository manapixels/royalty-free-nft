...
import IpNftFactoryContract from '../../../../hardhat/artifacts/contracts/IpNftFactory.sol/IpNftFactory.json'
import { IpNftFactoryContract as IpNftFactoryType } from '../types/typechain'
...
// const IpNftFactoryContract  = require("../../../../hardhat/artifacts/contracts/IpNftFactory.sol/IpNftFactory.json");
...
function renderDropzone(): JSX.Element {
  ...
  async function setContractGreeting(urlPath: string) {
    if (library) {
      const signer = library.getSigner()
      const contract = new ethers.Contract(
        "0xCC78280A93267D7E646e03207194510e0f09CF06",
        IpNftFactoryContract.abi,
        library
      ) as IpNftFactoryType
      const transaction = await contract.newIpNft("random" ,"random1" , urlPath)
  ...
  return (
    <>
      <Grid mt="2rem" fontSize="sm" templateColumns="repeat(3, 1fr)" gap="8">
        ...
        <GridItem>
        <Box mt="5">
        {multimedia && multimedia.map(item => (
